...
if ( ! class_exists( 'BB_Instagram' ) ) {
	...
	class BB_Instagram_Proxy {
		...
		public function js() {
			if( $this->hashtag != '' ){ ?>
			<script>
				var bt_bb_instagram_init_finished_<?php echo $this->feed_id; ?> = false;
	
				document.addEventListener('readystatechange', function() { 
					if ( ! bt_bb_instagram_init_finished_<?php echo $this->feed_id; ?> && ( document.readyState === 'interactive' || document.readyState === 'complete' ) && typeof Instafeed === 'function' ) {
						...
						feed.run();						
						bt_bb_instagram_init_finished_<?php echo $this->feed_id; ?> = true;		
					}
				}, false);
		...
		<?php } else { ?>
				...
				document.addEventListener('readystatechange', function() { 
					if ( ! bt_bb_instagram_init_finished_<?php echo $this->feed_id; ?> && ( document.readyState === 'interactive' || document.readyState === 'complete' ) ) {
						var feed = new Instafeed({
							get: 'user',
