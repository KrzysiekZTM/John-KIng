		...
		if ( $share_facebook ) {
				$share_html .= boldthemes_get_icon_html( 
					array ( 
						...
						'url_title' => esc_html__( 'Share on Facebook', 'craft-beer' ), 
						'style' => $style,
						'shape' => $shape,
						'size' => $size,
			...
			if ( $share_twitter ) {
				$share_html .= boldthemes_get_icon_html( 
					array ( 
						...
						'url_title' => esc_html__( 'Share on Twitter', 'craft-beer' ), 
						'style' => $style,
						'shape' => $shape,
						'size' => $size,
						'color_scheme' => $color_scheme, 
			...
			if ( $share_linkedin ) {
				$share_html .= boldthemes_get_icon_html( 
					array ( 
						...
						'url_title' => esc_html__( 'Share on Linkedin', 'craft-beer' ), 
						'style' => $style,
						'shape' => $shape,
						'size' => $size, 
						'color_scheme' => $color_scheme,
			...
			if ( $share_google_plus ) {
				$share_html .= boldthemes_get_icon_html( 
					array ( 
						...
						'url_title' => esc_html__( 'Share on Google Plus', 'craft-beer' ), 
						'style' => $style,
						'shape' => $shape,
						'size' => $size, 
						'color_scheme' => $color_scheme, 
			...
			if ( $share_vk ) {
				$share_html .= boldthemes_get_icon_html( 
					array ( 
						...
						'url_title' => esc_html__( 'Share on VK', 'craft-beer' ), 
						'style' => $style,
						'shape' => $shape,
						'size' => $size,  
						'color_scheme' => $color_scheme,
